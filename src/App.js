  ...
  return (
    <div className="container">
      <section className='info-input'>
        ...
        <div className="input">
          <div className="input-item"><Slider label="Amount of wolves:" min={1} max={50} value={amount} onValueChange={v => setAmount(v)}/></div>
          <div className="input-item"><Button label="Make some noise:" value="Step on a branch"/></div>
          <div className="input-item"><Select label="Choose mood:" /></div>
        </div>
      </section>
    </div>
  );
